...
let BuffFormComponent = class BuffFormComponent {
    ...
    onSubmit() {
        ...
        const round$ = this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["select"])('status'), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["select"])('Round'));
        let round;
...
BuffFormComponent.ctorParameters = () => [
...
/* harmony import */ var _actions_buff_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../actions/buff.actions */ "./src/app/actions/buff.actions.ts");
...
function reducer(state = initialState, action) {
    switch (action.type) {
        case _actions_buff_actions__WEBPACK_IMPORTED_MODULE_0__["ActionTypes"].AddBuff:
        ...
        case _actions_buff_actions__WEBPACK_IMPORTED_MODULE_0__["ActionTypes"].IncrementRound:
        ...
        case _actions_buff_actions__WEBPACK_IMPORTED_MODULE_0__["ActionTypes"].DecrementRound:
            if (state.Round > 1) {
        ...
        case _actions_buff_actions__WEBPACK_IMPORTED_MODULE_0__["ActionTypes"].ToggleEffect:
        ...
        case _actions_buff_actions__WEBPACK_IMPORTED_MODULE_0__["ActionTypes"].RemoveBuff:
...
class Buff {
    constructor(name, atk, dmg, save, duration, remaining, roundStarted, active) {
        this.name = name;
        this.atk = atk;
        this.dmg = dmg;
        this.save = save;
